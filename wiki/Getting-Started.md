...
Check the repository [current state](https://github.com/ronnierosal/Handheld-Docked-Mode-SteamOS/blob/main/docs/CURRENT_STATE.md)
and [deployment validation contract](https://github.com/ronnierosal/Handheld-Docked-Mode-SteamOS/blob/main/docs/DEPLOYMENT_VALIDATION.md)
...
and [development workflow](https://github.com/ronnierosal/Handheld-Docked-Mode-SteamOS/blob/main/docs/DEVELOPMENT.md)
before editing.
